...
assert_contains claude-primary.md "VERIFY -> BOUNDARY-CHECK"
assert_contains claude-primary.md "Never ACCEPT or REJECT a confirmed boundary conflict."
assert_absent claude-primary.md "VERIFY -> EVALUATE -> CLASSIFY -> PREMISE-CHECK -> UPDATE -> ACCEPT/REJECT"
